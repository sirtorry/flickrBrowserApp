...
//        GetRawData theRawData = new GetRawData("https://api.flickr.com/services/feeds/photos_public.gne?tags=android,lollipop&format=json&nojsoncallback=1");
        ...
        mRecyclerView.addOnItemTouchListener(new com.torryyang.flickrbrowser.RecyclerItemClickListener(this,
                mRecyclerView, new com.torryyang.flickrbrowser.RecyclerItemClickListener.OnItemClickListener() {
            @Override
